...
MAX_WAIT_TIME = 180 # الحد الأقصى للانتظار بالثواني
...
# البرومبت الخاص بمعالجة الملفات (توليد أسئلة وأمثلة)
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        while time.time() - start_time < MAX_WAIT_TIME:
            ...
            # تحديث الرسالة بالنسبة المئوية (لحل مشكلة عدم تعديل الرسالة)
            try:
            ...
            time.sleep(5) # الانتظار 5 ثواني قبل التحقق مرة أخرى
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # برومبت جديد لطلب إجابة مختصرة ومفيدة (لحل مشكلة طول الردود النصية)
