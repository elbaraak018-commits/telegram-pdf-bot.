...
# 🔑 الدالة المضافة لإنشاء / جلب كائن المحادثة مع الذاكرة
def get_or_create_chat(user_id, context: ContextTypes.DEFAULT_TYPE):
    """جلب كائن المحادثة الخاص بالمستخدم أو إنشاؤه إذا لم يكن موجوداً."""
    if not client:
        return None
    ...
    if chat_key not in context.user_data:
        ...
        # دمج الـ System Instruction لـ Gemini-Flash هنا
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1. التحقق من سؤال المطور (من أنشأك) - تم إضافة المزيد من العبارات هنا
    ...
    try:
        # ✅ استخدام chat.send_message للاحتفاظ بسجل المحادثة
        ...
        logging.error(f"Error in handle_text with chat: {e}")
