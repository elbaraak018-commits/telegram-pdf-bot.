...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    file_obj = update.message.document or (update.message.photo[-1] if update.message.photo else None) or update.message.video or update.message.audio or update.message.voice # إضافة دعم لـ voice object
    if not file_obj:
    ...
    if update.message.document and file_obj.file_name:
        ...
        extension = ext
         ...
         # إضافة امتداد افتراضي لملفات الصوت إن لم يكن موجوداً
        ...
        if not mime_type:
            ...
            # 🚨 التعديل لملفات الصوت
                ...
                if extension in ['.ogg', '.oga', '.opus']:
                    ...
                    mime_type = 'audio/wav'
                # إذا لم يتم تخمين نوع معين، نستخدم mp3 كنوع افتراضي آمن
                else:
                    mime_type = 'audio/mpeg' 
            # ---------------------------
...
def main():
    ...
    # ملاحظة: تم إضافة filters.VOICE لدعم الملاحظات الصوتية في تيليجرام
