...
# 3. الوظائف المساعدة
# ----------------------------------------
# ✅ تم تحسين هذه الدالة لحل مشكلة 'Message is too long'
def split_text(text, max_len=MAX_TELEGRAM_MESSAGE_LENGTH):
    ...
    # 1. البدء بتقسيم النص بناءً على فواصل الأسطر
...
# ----------------------------------------
# ✅ تم تعديل هذه الدالة لحل مشكلة 'unexpected keyword argument contents' ومشكلة 'Message to edit not found'
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        for i, part in enumerate(response_parts):
            ...
            if i == 0:
                # 🛠️ تعديل رسالة الانتظار لتصبح الجزء الأول
        ...
        try:
            ...
            # إذا لم يتمكن من تعديل رسالة الانتظار (ربما تم حذفها أو تجاوزت الوقت)، يرسل رسالة جديدة
