        ...
        try:
            ...
            if "429" in error_msg or "rate_limit_exceeded" in error_msg:
                ...
                if attempt == retries - 1:
                    ...
                    # تعديل رسالة الخطأ هنا بناءً على طلبك
...
async def media_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if mode == "pdf":
            ...
            await status.edit_text("🎧 جاري استخراج النص من المقطع الصوتي...")
...
async def audio_callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "audio_show_text":
        ...
        status_msg = await query.message.reply_text("⌛ جاري تحليل وشرح المحتوى...")
