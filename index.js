...
const { snapSave } = require('snapsave-downloader'); // المكتبة الجديدة لتحميل تيك توك
...
async function handleTikTokDownload(ctx, url) {
    ...
    try {
        // استخدام المكتبة الجديدة snapSave
        ...
        // اختيار أول رابط تحميل (الذي غالباً يكون بدون علامة مائية)
