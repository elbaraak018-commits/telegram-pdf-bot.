...
// *************************************************************
// ******* (مُعطّل مؤقتاً لضمان نجاح التشغيل بعد حل مشكلة الـ API) *******
// *************************************************************
...
// *** الحل النهائي لمشكلة [404 Not Found] بتغيير اسم النموذج ***
// نموذج gemini-pro مدعوم بشكل مضمون لجميع أنواع المفاتيح
...
bot.on('document', async (ctx) => {
    ...
    try {
        ...
        // 5. إرسال النتيجة (تقسيم النص إذا كان طويلاً جداً)
        ...
        // رسالة الخطأ هذه تشير إلى مشاكل الاتصال أو جودة الملف.
        await ctx.reply('❌ حدث خطأ أثناء المعالجة. تأكد من أن مفتاح API صحيح أو أن الملف لا يزيد عن 50 ميجابايت.');
    } finally {
        // 7. تنظيف السيرفر: حذف الملف المؤقت
