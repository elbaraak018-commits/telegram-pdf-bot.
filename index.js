...
// *************************************************************
// ******* (تعديل مؤقت لتخطي فحص المفاتيح ومعرفة سبب الانهيار) ******
// *************************************************************
...
bot.on('document', async (ctx) => {
    ...
    try {
        ...
        // في حال فشل الاتصال بـ Gemini بسبب مفتاح خطأ، سيظهر الخطأ هنا:
        await ctx.reply('❌ حدث خطأ أثناء المعالجة. قد يكون مفتاح API غير صالح، أو الملف كبيراً جداً.');
    } finally {
        // 6. تنظيف السيرفر: حذف الملف المؤقت
